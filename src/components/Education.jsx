...
const Education = () => {
  ...
  return (
    <section id="education" className="py-20 bg-white/60 dark:bg-black/55 shadow-2xl transition-colors duration-300">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
                ...
                {education.map((edu, index) => (
                  <li key={index} className="list-none">
                    <div className="relative rounded-2xl border border-border p-2">
                      ...
                      <div className="group relative bg-background p-8 rounded-xl shadow-sm border border-border overflow-hidden dark:shadow-[0px_0px_27px_0px_rgba(45,45,45,0.3)]">
                        {/* Header */}
                        <div className="mb-6">
            ...
            <div>
              ...
              {/* Research Experience */}
              <div className="relative mb-10 rounded-2xl border border-border p-2">
                <GlowingEffect spread={40} glow={true} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={2} />
                <div className="relative bg-background p-6 rounded-xl border border-border">
              ...
              <div className="space-y-6">
                {certifications.map((cert, index) => (
                  <li key={index} className="list-none">
                    <div className="relative rounded-2xl border border-border p-2">
                      <GlowingEffect spread={40} glow={true} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={2} />
                      <div className="group relative flex bg-background p-6 rounded-xl shadow-sm border border-border overflow-hidden dark:shadow-[0px_0px_27px_0px_rgba(45,45,45,0.3)] items-start gap-4">
