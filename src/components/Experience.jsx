...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-20 bg-white/60 dark:bg-black/55 shadow-2xl transition-colors duration-300">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              <div
                key={index}
                className={`relative mb-12 md:mb-16 ${index % 2 === 0 ? 'md:pr-1/2 md:text-right' : 'md:pl-1/2 md:ml-8'
                  }`}
              >
                {/* Timeline dot */}
                ...
                <div className="ml-12 md:ml-0">
                  <div className="relative rounded-2xl border border-border p-2">
                    ...
                    <div className="group relative bg-background p-8 rounded-xl shadow-lg border border-border overflow-hidden">
                      {/* Header */}
                      <div className="mb-6">
