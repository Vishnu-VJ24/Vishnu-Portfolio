    ...
    return (
        ...
        >
            <motion.div
                ...
                className={cn(
                    'flex w-fit gap-2 rounded-2xl px-3',
                    'bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-white/15 dark:border-white/10',
                    className
                )}
        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className={cn(
                        'absolute -top-7 left-1/2 w-fit whitespace-pre rounded-md px-2 py-0.5 text-xs font-medium',
