...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-white/60 dark:bg-black/55 shadow-2xl transition-colors duration-300">
                ...
                <div key={index}>
                  <div className="relative rounded-2xl border border-border p-2">
                    ...
                    <a
                      ...
                      className="group relative flex flex-col items-center text-center p-6 bg-background rounded-xl border border-border transition-all duration-300 hover:scale-105"
                    >
