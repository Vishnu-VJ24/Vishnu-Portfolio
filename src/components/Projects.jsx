...
const Projects = () => {
  ...
  const ProjectCard = ({ project, isFeatured = false }) => (
    <div className={isFeatured ? 'md:col-span-2' : ''}>
      <div className="relative h-full rounded-2xl border border-border p-2">
        ...
        <div className="group relative flex flex-col h-full bg-background rounded-xl shadow-sm border border-border overflow-hidden dark:shadow-[0px_0px_27px_0px_rgba(45,45,45,0.3)]">
          {/* Project Image */}
  ...
  return (
    <section id="projects" className="py-20 bg-white/60 dark:bg-black/55 shadow-2xl transition-colors duration-300">
