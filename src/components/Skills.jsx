...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-20 bg-white/60 dark:bg-black/55 shadow-2xl transition-colors duration-300">
            ...
            {skillCategories.map((category, categoryIndex) => (
              <li key={categoryIndex} className="list-none">
                <div className="relative h-full rounded-2xl border border-border p-2">
                  ...
                  <div className="group relative flex h-full flex-col bg-background p-8 rounded-xl shadow-sm border border-border overflow-hidden dark:shadow-[0px_0px_27px_0px_rgba(45,45,45,0.3)]">
